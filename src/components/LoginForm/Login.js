    ...
    async function login() {
        ...
        if (isValid) {
            ...
            if (result.roleId == 0) {
                ...
                localStorage.setItem("customer-info", JSON.stringify(result.userId))
                ...
                localStorage.setItem("user-info", JSON.stringify(result))
                localStorage.setItem("Shopkeper-info", JSON.stringify(result.userId))
                ...
                localStorage.setItem("user-info", JSON.stringify(result))
                localStorage.setItem("agent-info", JSON.stringify(result.userId))
                history?.push("/AgentComponent");
            }
        }
    }
                        ...
                        <div>
                            <table className="table">
                                <tr>
                                    ...
                                    <td><label><input type="radio" value="Delivery Agent" name="category" onChange={handleCategoryChange}></input>Agent</label></td>
                                </tr>
                                <tr>
                                    <td></td>
