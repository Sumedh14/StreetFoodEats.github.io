...
class NonVegComponent extends PureComponent {
  constructor(props) {
    super(props)
          ...
          <div className="row mb-3">
            <div className="row col-md-8">
              <Breadcrumb >
                ...
                <BreadcrumbItem active>Non-Veg</BreadcrumbItem>
              </Breadcrumb>
            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(NonVegComponent);