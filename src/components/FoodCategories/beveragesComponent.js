...
class BeveragesComponent extends PureComponent {
  constructor(props) {
    super(props)
          ...
          <div className="row mb-3">
            <div className="row col-md-8">
              <Breadcrumb >
                ...
                <BreadcrumbItem active>Beverages</BreadcrumbItem>
              </Breadcrumb>
            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(BeveragesComponent);